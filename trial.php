...
/>-->
   <div style="z-index: 1000;">     <br><br><br>
      <p style="font-size: 40px;">We create experiences</p>
      <br>
      <P>THAT BUILD <span style="color: blue;">MOTIVATON.</span><br>
      <button style="background:transparent;border-color: white;color: black; font-size: 30px;">FIND OUT MORE</button> </P>     
    </div></div>
    <div class="item">
      <br><br><br>
      <p style="font-size: 40px;">Inspired by purpose</p>
      <br>
      <P>DRIVEN BY <span style="color: blue;">PASSION.</span><br>
      <button style="background:transparent;border-color: white;color: black; font-size: 30px;">FIND OUT MORE</button> </P>
    </div>
    <div class="item">
     <br><br><br>
     <div class="container">
     <div class="row">
      <p style="font-size: 30px;">YOU'VE PROBABLY NOTICED</p>
      <br>
      <P>WE LOVE WHAT <span style="color: blue;">WE DO.</span><br>
      <button style="background:transparent;border-color: white;color: black; font-size: 30px;">FIND OUT MORE</button> </P>
    </div>
    </div>
    </div>
